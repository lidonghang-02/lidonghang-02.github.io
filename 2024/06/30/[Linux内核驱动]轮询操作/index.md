...
tags:
  - Linux
  - Linux内核驱动
source: https://blog.csdn.net/qq_66623299/article/details/140084498
description: 关于用户空间的轮询操作，poll，select，epoll等自行查询，这里只简单介绍设备驱动中的poll函数这个函数主要进行下面两项工作poll_table。
---
