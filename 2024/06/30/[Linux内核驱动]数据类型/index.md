...
tags:
  - Linux
  - Linux内核驱动
source: https://blog.csdn.net/qq_66623299/article/details/140085012
description: Wall。
---
...
packed 是__attribute__的一个常见用法，当将packed属性应用于结构体或联合体时，它会消除结构体内的任何填充（padding），确保结构体或联合体的成员在内存中紧密排列，没有间隙。
